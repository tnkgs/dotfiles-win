      ...
      ["core.keybinds"] = {
        config = {
          ...
          hook = function(keybinds)
            ...
            keybinds.map("norg", "n", "<LocalLeader>ntd", "<Plug>(neorg.qol.todo-items.todo.task-done)", { desc = "Task Done" })
            keybinds.map("norg", "n", "<LocalLeader>ntu", "<Plug>(neorg.qol.todo-items.todo.task-undone)", { desc = "Task Undone" })
            keybinds.map("norg", "n", "<LocalLeader>ntp", "<Plug>(neorg.qol.todo-items.todo.task-pending)", { desc = "Task Pending" })
            keybinds.map("norg", "n", "<LocalLeader>ntc", "<Plug>(neorg.qol.todo-items.todo.task-cancelled)", { desc = "Task Cancelled" })
            
            -- タスクサイクル（Ctrl+Space の代わり）
            keybinds.map("norg", "n", "<LocalLeader>nts", "<Plug>(neorg.qol.todo-items.todo.task-cycle)", { desc = "Task Cycle" })
            ...
            -- その他
            keybinds.map("norg", "n", "<LocalLeader>ncm", "<Plug>(neorg.looking-glass.magnify-code-block)", { desc = "Magnify Code Block" })
